 ...
 * @author user
 */
public class AlsSolverOld extends AbstractSolver {
    ...
    public AlsSolverOld(SudokuSolver solver) {
        super(solver);
...
//                }
    ...
    public List<SolutionStep> getAllAlses(Sudoku sudoku) {
        ...
        Logger.getLogger(AlsSolverOld.class.getName()).log(Level.FINE, "getAllAlses() total: " + millis1 + "ms");
        steps = oldSteps;
        if (save != null) {
            setSudoku(save);
        }
    ...
    private void getAlsXYWingInt() {
        ...
        for (int i = 0; i < restrictedCommons.size(); i++) {
            ...
            for (int j = i + 1; j < restrictedCommons.size(); j++) {
                ...
                // gemeinsamen Indices von rc1 und rc2 miteinander geprüft werden
    ...
    private void getAlsXYChainInt() {
        ...
        Logger.getLogger(AlsSolverOld.class.getName()).log(Level.FINER, steps.size() + " (maxRecDepth: " + maxRecDepth + ")");
    }
    ...
    private void getAlsXYChainRecursive(int alsIndex, int firstRestrictedCommon, Als lastAls) {
        ...
        if (recDepth % 100 == 0) {
            Logger.getLogger(AlsSolverOld.class.getName()).log(Level.FINER, "Recursion depth: " + recDepth);
        }
...
//            chain[1] = minIndex2 * 10 + cand;
    ...
    private void collectAllRestrictedCommons(boolean writeIndices) {
        Logger.getLogger(AlsSolverOld.class.getName()).entering(getClass().getName(), "collectAllRestrictedCommons()");
        ...
        for (int i = 0; i < alses.size(); i++) {
            ...
            Logger.getLogger(AlsSolverOld.class.getName()).log(Level.FINER, "als1: " + SolutionStep.getAls(als1));
            for (int j = i + 1; j < alses.size(); j++) {
                ...
                Logger.getLogger(AlsSolverOld.class.getName()).log(Level.FINER, "als2: " + SolutionStep.getAls(als2));
                ...
                if (rcAnz > 1) {
                    Logger.getLogger(AlsSolverOld.class.getName()).log(Level.FINER, rcAnz + " RCs for ALS " + SolutionStep.getAls(als1) + "/" + SolutionStep.getAls(als2));
                }
            }
            if (writeIndices) {
        ...
        Logger.getLogger(AlsSolverOld.class.getName()).log(Level.FINE, "collectAllRestrictedCommons(): " + ticks + "ms; restrictedCommon size: " + restrictedCommons.size());
    }
    ...
    class RestrictedCommon implements Comparable<RestrictedCommon> {
        ...
        @Override
        public int compareTo(AlsSolverOld.RestrictedCommon r) {
...
//        sudoku.setSudoku(":0000:x:8..7...4...43....667.1248.9.6.2.9...4..871625...6.3.9.3.6.12.871....73.2.2..3...4:112 512 513 913 515 922 525 128 343 543 743 167 972 982 485 585 985 596::");        
        AlsSolverOld as = new AlsSolverOld(null);
        as.setSudoku(sudoku);
